# site/api/app.py - MUDANÇA DA EXTENSÃO DE SAÍDA PARA .avi E CODEC MJPG
...
def analyze_video_and_extract_data(video_path, output_video_path):
    ...
    # MUDANÇA CRÍTICA: Usando CODEC MJPG para maior compatibilidade.
...
def process_analysis_route():
    ...
    try:
        ...
        # MUDANÇA: O video processado agora é .avi
...
def delete_analysis_route(analysis_id):
    ...
    try:
        ...
        # MUDANÇA: O caminho de exclusão agora procura por .avi
        video_processed_filepath = os.path.join(VIDEO_DIR, f"{analysis_id}_frontal.avi") 
